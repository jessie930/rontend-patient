    ...
    <div class=" mb-4">
      <div class="card">
        <div class="card-body text-white mailbox-widget pb-0" style="background-color: #567890;">
          <h4 class="text-white pb-3">Our Locations</h4>
        </div>
      </div>
    </div>
    <!--
        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr v-for="booking in bookings" :key="booking._id">
              ...
              <td> <router-link to="/login"><button style="width: 80%; display: flex; justify-content: center;" class="btn btn-success">BOOK</button></router-link> </td>
            </tr>
          </tbody>
        </table>
      </div>
